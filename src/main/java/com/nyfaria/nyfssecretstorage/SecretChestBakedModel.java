...
public class SecretChestBakedModel implements IDynamicBakedModel {

    public static final ResourceLocation TEXTURE = new ResourceLocation(NyfsSecretStorage.MOD_ID, "block/secret_chest");
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        BlockState mimic = extraData.getData(SecretChestTile.MIMIC);
        if (mimic != null && !(mimic.getBlock() instanceof SecretChest)) {
